...
# This is the FINAL CLEAN VERSION with all fixes applied
...
import sys
import importlib
modules_to_clear = [m for m in list(sys.modules.keys()) if 'kernel' in m or 'optimizer' in m or 'llm_optimizer' in m]
